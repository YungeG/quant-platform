...
| `V5-PIN-01` | READY_FOR_ACCEPTANCE | root workspace/lock/gitlink now pins accepted fan-in `8de544e7794ee05b652355c9809b5454d7ace494`; clean receipt pending |
| `DG-ADM-01` | BLOCKED | requires completed V5-PIN-01 |
| `RP-DG-01` | BLOCKED | requires completed V5-PIN-01 |
...
FI-03 + BT-PORT-02 ─→ V5-CON-01 [APPROVED]
                           └─→ V5-PIN-01 [READY_FOR_ACCEPTANCE]
                                  ├─→ DG-ADM-01 ──────────────────┐
...
| 3 | `V5-PIN-01` | `DG-ADM-01`, `RP-DG-01` | root pyproject/uv.lock/gitlink | READY_FOR_ACCEPTANCE |
