...
| `RP-DG-01` | IN_PROGRESS | Research exact V2 dispatch is the active single-writer package lane |
...
FI-03 + BT-PORT-02 ─→ V5-CON-01 [APPROVED]
                           └─→ V5-PIN-01 [DONE]
                                  ├─→ DG-ADM-01 [DONE] ────────────────┐
                                  └─→ RP-DG-01 [IN_PROGRESS] ─→ SV-DG-01 ─┼─→ PG-DG-01
                                                                 └─→ DG-THIN-01 ─→ FI-04
```
...
| 5 | `RP-DG-01` | `SV-DG-01` | Research integration/runtime/tests | IN_PROGRESS |
