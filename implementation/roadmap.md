...
| `V2-SEAM-01` | READY | MB-CORE and BT-MODEL are complete; update root lock and prove the real public binding |
...
| 5 | `V2-SEAM-01` | SV-MODEL/FI-02 | root lock/gitlink/integration receipt | READY |
