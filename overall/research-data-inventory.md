...
- The alignment candidate lives at `/home/ygguo/agent-projs/ai-crypt/platform-dependency-alignment`. The original `platform` environment is not implicitly upgraded by creating that worktree. Use the dependency-alignment receipt and runtime import check to determine whether a later cutover has occurred.
