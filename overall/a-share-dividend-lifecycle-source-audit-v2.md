...
- 已完成月份：2025-01、02、03、04；
- 捕获实施公告：329份；
- 现金分红公告：327份，纯送转无现金公告2份；
- 当前沪深普通A股现金分红范围：309份；
- 沪深普通A股完整解析：309/309；
- 提取字段：公告日、股权登记日、除权除息日、现金红利发放日、税前每股现金红利；
- 北交所范围7份仍有格式差异，但不属于当前`.SH/.SZ`策略范围；
- 每月原始与规范化SHA256见`a-share-cninfo-dividend-2025-monthly-summary.csv`。
...
2025全年精确标题匹配为4552份，目前完成4/12个月，继续按月检查点采集。更重要的是，实施公告只证明最终登记、除权和支付安排，尚不构成完整的声明、股东大会批准、取消、更正和替换链。
