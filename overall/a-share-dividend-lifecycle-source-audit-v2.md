...
- 已完成：2025-01、02、03、04及2025-05-01—05-07；
- 捕获实施公告：360份；
- 现金分红公告：358份，纯送转无现金公告2份；
- 当前沪深普通A股现金分红范围：337份；
- 沪深普通A股完整解析：337/337；
...
2025全年精确标题匹配为4552份，目前完成4个整月及5月首周；5月和6月分别约1273和1284份，后续继续按周检查点采集。更重要的是，实施公告只证明最终登记、除权和支付安排，尚不构成完整的声明、股东大会批准、取消、更正和替换链。
