...
- 已完整覆盖：2025-01、02、03、04、05；
- 捕获实施公告：1602份；
- 现金分红公告：1590份，纯送转无现金公告12份；
- 当前沪深普通A股现金分红范围：1466份；
- 沪深普通A股完整解析：1466/1466；
...
2025全年精确标题匹配为4552份，目前完成前5个月；6月约1284份，后续继续按日/周拆分检查点采集。更重要的是，实施公告只证明最终登记、除权和支付安排，尚不构成完整的声明、股东大会批准、取消、更正和替换链。
